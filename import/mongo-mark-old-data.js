...
printjson('scriptures', db.scriptures.updateMany({}, {$set:{before_update: new Date()}}))
...
printjson('years-grouped', db['years-grouped'].updateMany({}, {$set:{before_update: new Date()}}))
